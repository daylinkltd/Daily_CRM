...
Cohesion: 0.05
Nodes (65): EDITABLE_STATUSES, isDryRun(), collectVariableSlots(), TemplateFormData, DELETE(), PATCH(), POST(), buildUpsertRow() (+57 more)

### Community 15 - "DealCard / DealCardProps"
Cohesion: 0.21
Nodes (9): NodeData, BuilderState, FlowEditorContextValue, FlowEditorCtx, FlowEditorProvider(), BuilderNode, NodeType, ValidationIssue (+1 more)
...
Cohesion: 0.18
Nodes (10): FlowBuilder(), CanvasAddNodeButton(), FlowCanvasInner(), useFlowEditor(), EditorHeader(), StatusBadge(), IssueLine(), ValidationPanel() (+2 more)
...
Cohesion: 0.19
Nodes (11): ComposerMediaKind, formatDuration(), MediaDraft, MediaDraftPreview(), MessageComposer(), MessageComposerProps, PICKER_ACCEPT, ReplyDraft (+3 more)
...
Cohesion: 0.07
Nodes (32): POST(), computeSHA256(), POST(), DELETE(), GET(), POST(), GET(), GET() (+24 more)
...
Cohesion: 0.19
Nodes (16): AuthProvider(), useAuth(), useTheme(), OnboardingPage(), AdminLayout(), AdminLayoutInner(), ApiKeysSettings(), AppearancePanel() (+8 more)
...
Cohesion: 0.06
Nodes (34): NodeEditSheet(), describeTrigger(), FlowCard(), ModeToggle(), cn(), EVENT_COLOR, EventLine(), EventRow (+26 more)
...
Cohesion: 0.17
Nodes (21): useTotalUnread(), WorkspacePermissions, bottomNavItems, NavGroup, navGroups, Sidebar(), SidebarProps, DropdownMenu() (+13 more)

### Community 46 - "vitest.config"
Cohesion: 0.20
Nodes (12): PresenceMap, UsePresenceResult, derivePresence(), formatLastSeen(), presenceLabel(), PresenceRow, PresenceStatus, StoredPresence (+4 more)

### Community 47 - "CLAUDE.md"
Cohesion: 0.15
Nodes (13): AccountContext, RequireRole(), RequireRoleProps, AccountRole, AuthContextValue, Profile, EDITABLE_ROLES, Invitation (+5 more)
...
Cohesion: 0.29
Nodes (10): RealtimeEvent, useRealtime(), UseRealtimeOptions, ContactSidebar(), ContactSidebarProps, MessageActionsProps, NewChatModal(), InboxPage() (+2 more)
...
Cohesion: 0.24
Nodes (11): ConversationItem(), ConversationItemProps, ConversationList(), ConversationListProps, FILTER_OPTIONS, InboxFilter, STATUS_COLORS, NewChatModalProps (+3 more)
...
Cohesion: 0.31
Nodes (8): FlowEditorShell(), Props, ToggleButton(), useMatchMedia(), View, ProviderProps, FlowNodeRow, FlowRow
...
Cohesion: 0.35
Nodes (10): usePresence(), formatDateSeparator(), groupMessagesByDate(), MessageThread(), MessageThreadProps, renderTemplateBody(), ReplyDraft, STATUS_OPTIONS (+2 more)
...
Cohesion: 0.11
Nodes (24): ContactDetailView(), ContactDetailViewProps, EditQuotationPage(), LocalLineItem, LocalSection, PageProps, TAB_VALUES, TabValue (+16 more)
...
Cohesion: 0.12
Nodes (29): BuilderStep, StepListProps, DispatchInput, ExecuteArgs, AutomationCard(), AutomationsPage(), TEMPLATE_ICON, TEMPLATE_ORDER (+21 more)
...
Cohesion: 0.12
Nodes (17): applyEdgeConnection(), CanvasEdge, deriveCanvasEdges(), OutgoingSlot, outgoingSlots(), unlinkNodeReferences(), ADD_NODE_TYPES, FlowCanvas() (+9 more)
...
Cohesion: 0.11
Nodes (20): AdminDashboard(), ALL_CHANNELS, DealLostReason, DealSource, GROWTH_LIMITS, Prospect, STATUS_CONFIG, UserProfile (+12 more)
...
Cohesion: 0.40
Nodes (5): buildMediaPath(), deleteAccountMedia(), MEDIA_MAX_BYTES_BY_KIND, uploadAccountMedia(), UploadAccountMediaResult
...
- **Why does `cn()` connect `config / postcss.config.mjs` to `Automations UI & Config`, `Automation Visual Builder UI`, `Shared Design System Components`, `TypeScript & Build Configs`, `AdminDashboard / UserProfile`, `BuilderStep / AUTOMATION TEMPLATES`, `AudienceConfig / BroadcastApiResult`, `RealtimeEvent / UseRealtimeOptions`, `isTabValue / SettingsPage`, `ContactSidebar / ContactSidebarProps`, `inter / metadata`, `DashboardLayout / metadata`, `next-env.d`, `vitest.config`, `CLAUDE.md`, `Community 50`, `Community 51`, `Community 53`, `Community 57`, `Community 58`, `Community 62`, `Community 63`, `Community 66`, `Community 69`, `Community 78`, `Community 93`, `Community 95`, `Community 99`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `createClient()` connect `AutomationCard / formatRelative` to `Dashboard Charts & Activity Feed`, `Community 66`, `API Routes & Step Trees`, `Automation Execution Engine`, `Community 71`, `Community 103`, `SECURITY HEADERS / next.config`, `Workspace Tooling Configurations`, `Contacts & Deals Management`, `BroadcastResult / NewRecipient`, `engineSendTemplate / engineSendText`, `AudienceConfig / audienceOptions`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `createClient()` connect `AuthContext / AuthContextValue` to `Automations UI & Config`, `TypeScript & Build Configs`, `contactFields / SAMPLE CONTACT`, `AudienceConfig / BroadcastApiResult`, `isTabValue / SettingsPage`, `POST / route`, `AGENTS.md / This is NOT the Next.js y...`, `SECURITY HEADERS / next.config`, `next-env.d`, `vitest.config`, `Community 50`, `Community 53`, `Community 58`, `Community 62`, `Community 63`, `Community 66`, `Community 68`, `Community 69`, `Community 95`, `Community 99`, `Community 101`?**
