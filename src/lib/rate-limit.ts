...
export const RATE_LIMITS = {
  ...
  /** Self-serve signup (public, per-IP). Accounts are created
   *  server-side and pre-confirmed, so this is the only brake on
   *  automated account creation — keep it tight. */
