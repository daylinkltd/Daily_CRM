...
export const MESSAGING_SETTINGS: SettingDef[] = [
  ...
  { key: 'smtp_from', label: 'From address', channel: 'email', secret: false, required: false, placeholder: 'Blank sends as the username above', envFallback: 'PLATFORM_SMTP_FROM' },
