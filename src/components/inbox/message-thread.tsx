...
const STATUS_OPTIONS: { label: string; value: ConversationStatus; color: string }[] = [
  { label: "Open", value: "open", color: "text-[#00aef0]" },
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <Badge
            ...
            className={cn(
              ...
              sessionInfo.expired ? "text-red-400" : "text-[#00aef0]"
            )}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              className={cn(
                "inline-flex items-center justify-center h-7 gap-1 px-2 text-xs rounded-md hover:bg-slate-800",
                assignedAgentId ? "text-[#00aef0]" : "text-slate-400"
              )}
            >
                ...
                profiles.map((p) => {
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      className={cn(
                        "text-sm",
                        isSelected ? "text-[#00aef0]" : "text-slate-300"
                      )}
                    >
