...
function MessageContent({ message }: { message: Message }) {
  switch (message.content_type) {
    ...
    case "template":
      return (
        <div>
          <span className="mb-1 inline-flex items-center gap-1 rounded bg-[#00aef0]/20 px-1.5 py-0.5 text-[10px] font-medium text-[#00aef0]">
    ...
    >
      <div
        className={cn(
          ...
          isAgent
            ? "rounded-br-md bg-[#00aef0] text-white"
