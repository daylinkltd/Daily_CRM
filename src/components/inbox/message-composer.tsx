    ...
    <div className="border-t border-slate-800 bg-slate-900 p-3">
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          ...
          rows={1}
          className={cn(
            "flex-1 resize-none rounded-xl border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder-slate-500 outline-none transition-colors focus:border-[#00aef0]/50",
        ...
        <Button
          size="sm"
          className="h-9 w-9 shrink-0 bg-[#00aef0] p-0 hover:bg-[#00aef0] disabled:opacity-40"
