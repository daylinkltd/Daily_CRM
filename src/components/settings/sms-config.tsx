        ...
        <Card className="bg-slate-900 border-slate-700 ring-0 ring-transparent">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input value={accountSid} onChange={(e) => setAccountSid(e.target.value)} className="bg-slate-800 border-slate-700 text-foreground placeholder:text-slate-500" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input value={fromNumber} onChange={(e) => setFromNumber(e.target.value)} placeholder="+1234567890" className="bg-slate-800 border-slate-700 text-foreground placeholder:text-slate-500" />
            </div>
          </CardContent>
        </Card>
