...
export function SocialComposerForm({
  ...
  const handleAction = (targetAction: PostStatus | 'publish_now') => {
    ...
    const payload: Partial<SocialPost> = {
      ...
      video_prompt: initialPost?.video_prompt,
      image_prompt_version: initialPost?.image_prompt_version,
      video_prompt_version: initialPost?.video_prompt_version,
      objective: initialPost?.objective,
      date: date || undefined,
      time: time || '12:00',
      approverId,
