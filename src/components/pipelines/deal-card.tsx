  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {deal.status === "won" && (
          <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-[#00aef0]/15 px-2 py-0.5 text-[10px] font-semibold text-[#00aef0]">
      ...
      <div className="mt-2 flex items-center justify-between">
        <span className="text-sm font-bold text-[#00aef0]">
      ...
      {assigneeLabel && (
        <div className="mt-2 flex items-center justify-end">
          <span
            title={assigneeLabel}
            className="flex h-5 w-5 items-center justify-center rounded-full bg-[#00aef0]/15 text-[10px] font-semibold text-[#00aef0]"
          >
