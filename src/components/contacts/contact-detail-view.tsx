          ...
          <div className="flex flex-col h-full">
            ...
            <SheetHeader className="p-4 border-b border-slate-700/50">
              <div className="flex items-center gap-3">
                <Avatar className="size-12 bg-slate-800 border border-slate-700">
                  <AvatarFallback className="bg-[#00aef0]/10 text-[#00aef0] text-sm font-medium">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mt-1.5 text-xs text-slate-400">
                    <button
                      onClick={copyPhone}
                      className="flex items-center gap-1 hover:text-[#00aef0] transition-colors cursor-pointer"
                    >
                      <Phone className="size-3" />
                      {contact.phone}
                      {copiedPhone ? (
                        <Check className="size-3 text-[#00aef0]" />
                      ) : (
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-slate-800/50 border-b border-slate-700 mx-4 mt-3">
                <TabsTrigger
                  value="details"
                  className="data-active:bg-slate-800 data-active:text-[#00aef0] text-slate-400"
                >
                  Details
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="details" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    className="bg-[#00aef0] hover:bg-[#00aef0] text-white w-full"
                    size="sm"
                  >
                    {savingDetails ? (
                        ...
                        return (
                          <button
                            ...
                            className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium transition-all cursor-pointer ${
                              selected
                                ? 'ring-2 ring-[#00aef0] ring-offset-1 ring-offset-slate-900'
              ...
              <TabsContent value="deals" className="flex-1 overflow-y-auto px-4 py-3">
                {loadingDeals ? (
                  <div className="flex items-center justify-center py-8">
                    <Loader2 className="size-5 animate-spin text-[#00aef0]" />
                  </div>
                ) : deals.length === 0 ? (
