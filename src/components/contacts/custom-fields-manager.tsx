...
/**
 * Create / rename / delete workspace-scoped custom contact field definitions.
...
export function CustomFieldsPanel() {
  ...
  // Load the field list on mount once the workspace is known. The setters
  ...
  }, [activeWorkspace?.id, fetchFields]);
  ...
  async function handleCreate() {
    ...
    if (!activeWorkspace?.id || !user) {
      toast.error('Your profile is not linked to a workspace.');
      return;
    }
    if (isDuplicate(name)) {
