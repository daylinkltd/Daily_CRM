  ...
  if (!form) {
    return (
      <div className="min-h-screen bg-[#0b0f19] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="relative max-w-md w-full rounded-2xl border border-border bg-muted/60 backdrop-blur-md p-8 text-center shadow-xl space-y-4">
  ...
  if (!form.is_active) {
    return (
      <div className="min-h-screen bg-[#0b0f19] flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="relative max-w-md w-full rounded-2xl border border-border bg-muted/60 backdrop-blur-md p-8 text-center shadow-xl space-y-4">
          <div className="size-16 rounded-full bg-muted text-muted-foreground flex items-center justify-center mx-auto border border-border">
            <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
