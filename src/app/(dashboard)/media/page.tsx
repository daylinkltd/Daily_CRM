              ...
              {folders.map(folder => (
                ...
                >
                  ...
                  <button 
                    ...
                    className="absolute top-2 right-2 p-1.5 bg-background/80 hover:bg-red-500/20 text-muted-foreground hover:text-red-400 rounded-md opacity-0 group-hover:opacity-100 transition-opacity"
                  >
