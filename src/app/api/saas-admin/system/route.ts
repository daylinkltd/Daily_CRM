...
export async function GET(request: Request) {
  ...
  const config: Record<string, ConfigItem[]> = {
    ...
    'Platform messaging': [
      ...
      inspect('PLATFORM_WA_PHONE_ID', 'Platform WhatsApp phone id', 'Dailybiz-to-tenant WhatsApp. Separate from tenant numbers.', false),
      inspect('PLATFORM_WA_TOKEN', 'Platform WhatsApp token', 'Dailybiz-to-tenant WhatsApp. Separate from tenant numbers.', false),
