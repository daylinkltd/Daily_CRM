...
import { Shield, LayoutDashboard, LogOut, Menu, Building2, Users, Megaphone, ScrollText, Settings2, Inbox, TicketPercent, IndianRupee, MessageSquareText } from "lucide-react";
...
const NAV = [
  ...
  { href: "/saas-admin/revenue", label: "Revenue", icon: IndianRupee },
  { href: "/saas-admin/messaging", label: "Messaging", icon: MessageSquareText },
